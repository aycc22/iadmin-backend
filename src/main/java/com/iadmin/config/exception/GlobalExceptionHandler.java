package com.iadmin.config.exception;
...
public class GlobalExceptionHandler {
    ...
    public JSONObject httpRequestMethodHandler() throws Exception {
        return IAUtil.errorJson(ErrorEnum.E_500);
    }
    ...
    public JSONObject unauthorizedExceptionHandler() throws Exception {
        return IAUtil.errorJson(ErrorEnum.E_502);
    }
    ...
    public JSONObject unauthenticatedException() throws Exception {
        return IAUtil.errorJson(ErrorEnum.E_20011);
    }
    ...
    public JSONObject UnknownAccountException() throws Exception {
        return IAUtil.errorJson(ErrorEnum.E_20011);
    }
}
